...
{
    public class ChromeForFullScreenShots : ChromeDriver
    {
        ...
        public ChromeForFullScreenShots(ChromeOptions options)
            : base(ChromeDriverService.CreateDefaultService(), options)
        {
